# Batch Inference
To set up batch inference job via scheduled Databricks workflow, please refer to [mlops_stacks_april2025/resources/README.md](../../resources/README.md)
...
df.write.mode("overwrite").saveAsTable(
    name="<catalog>.uc_models.feature_store_inference_input"
)
```
