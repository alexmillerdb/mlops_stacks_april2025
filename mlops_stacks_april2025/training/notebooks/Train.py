...
# ``mlops_stacks_april2025/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-mlops_stacks_april2025-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.uc_models.mlops_stacks_april2025-model", label="Full (Three-Level) Model Name"
)
