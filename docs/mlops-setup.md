...
git add README.md docs .gitignore mlops_stacks_april2025/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlops_stacks_april2025/databricks.yml](../mlops_stacks_april2025/databricks.yml) file.
...
Follow the instructions in [mlops_stacks_april2025/resources/README.md](../mlops_stacks_april2025/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_stacks_april2025/resources/README.md)  to propose, test, and deploy
